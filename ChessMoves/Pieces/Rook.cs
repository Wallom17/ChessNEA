...
namespace ChessGame
{
    public class Rook : Piece
    {
        ...
        private static readonly Directions[] dirs = new Directions[] { Directions.Up, Directions.Down, Directions.Left, Directions.Right }; // all possible directions a rook can move
